  ...
  return (
    <main className="min-h-screen grid-bg overflow-hidden" style={{ background: "var(--bg)" }}>
      ...
      <section className="relative mx-auto px-8 pb-24" style={{ maxWidth: "86rem" }}>
        <div className="rounded-[32px] border p-6 md:p-10" style={{ borderColor: "var(--border)", background: "linear-gradient(135deg, rgba(0,255,209,0.07), rgba(123,97,255,0.08))" }}>
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {integrationSteps.map((step) => {
                ...
                return (
                  <div key={step.title} className="rounded-3xl border p-5" style={{ borderColor: "rgba(255,255,255,0.08)", background: "rgba(5,5,8,0.45)" }}>
