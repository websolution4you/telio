...
export function TennisBallAvatar({
  ...
  return (
    <div
      className={`relative shrink-0 select-none overflow-hidden rounded-full shadow-[0_3px_10px_rgba(0,0,0,0.15)] ${className}`}
    >
      ...
      >
        <defs>
          <radialGradient id="tennisBallGrad" cx="35%" cy="30%" r="70%">
        ...
        {/* Ball Base Circle */}
        <circle cx="18" cy="18" r="17.5" fill="url(#tennisBallGrad)" />
