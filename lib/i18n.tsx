...
export const translations = {
  en: {
    ...
    hero: {
      ...
      sub: "Telio is your 24/7 voice assistant. It answers every call, speaks naturally in Slovak and other languages, books appointments, dispatches taxis — and never takes a day off.",
    ...
    useCases: {
      ...
      h2a: "One AI agent.",
      h2b: "Any business.",
            actionLine: "Action completed · Reservation system updated",
      liveLabel: "TELIO · LIVE CALL SIMULATION",
      cases: [
                {
          id: "sports-center", emoji: "🎾", label: "Tennis Center",
          title: "Court bookings without waiting on the phone",
          description: "Telio handles court bookings by phone, asks for the sport, date and time, checks current availability in the booking system and confirms the reservation immediately. Tennis, badminton and squash bookings stay together in one clear calendar.",
          features: ["Real-time court availability for tennis, badminton and squash", "Automatic booking creation in the Telio reservation system", "Web and voice bookings together in one calendar", "Booking lookup and cancellation by phone"],
          callSample: [
            { role: "caller", text: "Dobrý deň, chcel by som si rezervovať bedmintonový kurt." },
            { role: "ai", text: "Dobrý deň! Na ktorý deň a čas si želáte rezerváciu?" },
            { role: "caller", text: "Na zajtra o 18:00 na jednu hodinu." },
            { role: "ai", text: "Kurt je voľný. Rezerváciu na zajtra o 18:00 som vám potvrdila." },
          ],
          color: "var(--cyan)",
        },
        {
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ["300 minutes included / month", "Rate 0.23€ / min after limit", "Full analytics dashboard", "Confirmation via WhatsApp + SMS"],
        ...
        },
        {
          ...
          features: ["More than 1000 minutes", "Priority support", "Full analytics dashboard", "Custom integrations", "Onboarding & training"],
          cta: "Try for free", highlighted: false, badge: null,
        },
      ],
    },
    waitlist: {
      ...
      h2b: "your business.",
      sub: "Fill out our form and we'll contact you within 48 hours.",
    ...
    dashboard: {
      adminOverview: "NTC Overview",
      adminSubtitle: "Management of all bookings and system statistics.",
      ...
      noData: "No data yet.",
      upcomingBookings: "Upcoming Bookings (All)",
      date: "Date",
      time: "Time",
      customer: "Customer",
      court: "Court",
      ...
      blockCourt: "Block Court (Maintenance)",
      logout: "Logout",
      adminAccess: "Admin Access",
      userOverview: "Your Overview",
      userSubtitle: "Management of your bookings and personal statistics.",
      playedThisMonth: "Played this month",
      hours: "hours",
      yourBookings: "Your Bookings",
      totalBookings: "total bookings",
      cancel: "Cancel",
      noUpcoming: "No upcoming bookings in the system.",
      noActive: "You have no active bookings.",
  ...
  sk: {
    ...
    useCases: {
      ...
      h2b: "Akákoľvek prevádzka.",
            actionLine: "Akcia dokončená · Rezervačný systém aktualizovaný",
      liveLabel: "TELIO · SIMULÁCIA ŽIVÉHO HOVORU",
      cases: [
                {
          id: "sports-center", emoji: "🎾", label: "Tenisové centrum",
          title: "Rezervácie kurtov bez čakania na linke",
          description: "Telio vybaví telefonické rezervácie kurtov, opýta sa na šport, dátum a čas, overí aktuálnu dostupnosť priamo v rezervačnom systéme a rezerváciu okamžite potvrdí. Tenis, bedminton aj squash zostávajú spolu v jednom prehľadnom kalendári.",
          features: ["Dostupnosť tenisových, bedmintonových a squashových kurtov v reálnom čase", "Automatické vytvorenie rezervácie v systéme Telio", "Webové aj hlasové rezervácie spolu v jednom kalendári", "Vyhľadanie a zrušenie rezervácie cez telefón"],
          callSample: [
            { role: "caller", text: "Dobrý deň, chcel by som si rezervovať bedmintonový kurt." },
            { role: "ai", text: "Dobrý deň! Na ktorý deň a čas si želáte rezerváciu?" },
            { role: "caller", text: "Na zajtra o 18:00 na jednu hodinu." },
    ...
    integrations: {
      sub: "Postavené na najspoľahlivejších technológiách sveta",
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ["300 minút v cene / mesiac", "Cena 0,23€ / min po prevolaní", "Kompletný analytický dashboard", "Potvrdenie cez WhatsApp + SMS"],
        ...
        },
        {
          ...
          features: ["Viac ako 1000 minút", "Prioritná podpora", "Kompletný analytický dashboard", "Vlastné integrácie", "Onboarding a školenie"],
          cta: "Vyskúšať zdarma", highlighted: false, badge: null,
        },
      ],
    },
    waitlist: {
      ...
      h2b: "svoju prevádzku.",
      sub: "Vyplňte náš formulár a my Vás budeme kontaktovať do 48 hodín.",
    ...
    dashboard: {
      adminOverview: "Prehľad NTC",
      adminSubtitle: "Správa všetkých rezervácií a systémové štatistiky.",
      estimatedRevenue: "Odhadované Tržby",
      activeToday: "Dnes Aktívne",
      bookings: "rezervácie",
      courts: "kurtov",
      topCustomers: "Top 5 Zákazníkov",
      noData: "Zatiaľ žiadne dáta.",
      upcomingBookings: "Nadchádzajúce rezervácie (Všetci)",
      date: "Dátum",
      time: "Čas",
      customer: "Zákazník",
      court: "Kurt",
      ...
      cancelled: "Zrušené",
      maintenance: "Údržba",
      blockCourt: "Zablokovať kurt (Údržba)",
      logout: "Odhlásiť sa",
      adminAccess: "Admin Prístup",
      userOverview: "Tvoj Prehľad",
      userSubtitle: "Správa tvojich rezervácií a osobná štatistika.",
      playedThisMonth: "Odohrané tento mesiac",
      hours: "hodín",
      yourBookings: "Tvoje Rezervácie",
      totalBookings: "rezervácií celkovo",
      cancel: "Zrušiť",
      noUpcoming: "Žiadne nadchádzajúce rezervácie v systéme.",
      noActive: "Nemáš žiadne aktívne rezervácie.",
      noPast: "Žiadne predošlé rezervácie.",
