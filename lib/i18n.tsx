    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ["10+ AI voice assistants", "More than 5000 minutes", "Priority 24/7 support", "Custom integrations", "Onboarding & training"],
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ["10+ hlasových asistentov", "Viac ako 5000 minút", "Prioritná podpora do 24 hodín", "Vlastné integrácie", "Onboarding a školenie"],
