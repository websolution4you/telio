    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ["3 AI voice assistants *", "300 minutes included / month", "Rate 0.23€ / min after limit", "Full analytics dashboard", "Confirmation via WhatsApp + SMS"],
        ...
        },
        {
          ...
          features: ["10+ AI voice assistants", "More than 1000 minutes", "Priority support", "Full analytics dashboard", "Custom integrations", "Onboarding & training"],
          cta: "Try for free", highlighted: false, badge: null,
        },
      ],
    },
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ["3 hlasoví asistenti *", "300 minút v cene / mesiac", "Cena 0,23€ / min po prevolaní", "Kompletný analytický dashboard", "Potvrdenie cez WhatsApp + SMS"],
        ...
        },
        {
          ...
          features: ["10+ hlasových asistentov", "Viac ako 1000 minút", "Prioritná podpora", "Kompletný analytický dashboard", "Vlastné integrácie", "Onboarding a školenie"],
          cta: "Vyskúšať zdarma", highlighted: false, badge: null,
        },
      ],
    },
